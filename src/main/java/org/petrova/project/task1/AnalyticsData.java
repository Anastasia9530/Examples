...
public class AnalyticsData {
    ...
    public Integer getEven() {return this.even;}

    public Integer getOdd() {return this.odd;}

    public Integer getResult() {return this.result;}

    public Integer getSum1() {return this.sum1;}

    public Integer getSumeven() {return this.sumeven;}

    public Integer getSumodd() {return this.sumodd;}
